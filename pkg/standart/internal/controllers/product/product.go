...
type Interface interface {
	ListOne(ID uint) (entity product.Product, err error)
	ListAll() (entities []product.Product, err error)
	Create(entity product.Product) (uint, error)
	Update(ID uint, entity product.Product) error
...
func (c *Controller) ListOne(ID uint) (entity product.Product, err error) {
...
func (c *Controller) Create(entity product.Product) (uint, error) {
...
func (c *Controller) Update(ID uint, entity product.Product) error {
...
func (c *Controller) Remove(ID uint) error {
	var entity product.Product
